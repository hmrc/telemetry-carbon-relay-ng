...
IMAGE_NAME="telemetry-carbon-relay-ng"
...
package() {
  ...
  docker build --tag "634456480543.dkr.ecr.eu-west-2.amazonaws.com/telemetry-carbon-relay-ng:${VERSION}" --tag "634456480543.dkr.ecr.eu-west-2.amazonaws.com/telemetry-carbon-relay-ng:" .
  print_completed
}
...
publish_to_ecr() {
  ...
  docker push "634456480543.dkr.ecr.eu-west-2.amazonaws.com/telemetry-carbon-relay-ng:latest"
  print_completed
}
